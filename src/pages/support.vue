  ...
  >
    ...
    >
      ...
      <v-col
        cols="12"
        md="4"
        class="pr-md-4 user-list-container"
        style="border-right: 1px solid #ccc;"
      >
        <v-list>
          <v-list-item-title class="pa-4 text-h6">
            Conversas
          </v-list-item-title>
          <v-divider />
          <div
          ...
          <div
            v-else-if="clients.length === 0 && !isLoadingClients"
      ...
      <v-col
        cols="12"
        md="8"
        class="d-flex flex-column pl-md-4 chat-area-container"
      >
        <div
          v-if="selectedClient"
        ...
        >
          ...
          <div
            ...
            class="flex-grow-1 overflow-y-auto my-4 px-2 message-list"
          ...
          >
            ...
            <div
              v-if="!isLoadingMessages && messages.length === 0 && selectedClient"
              class="text-center text-grey pa-5"
            >
        ...
        <div
          v-else
          class="d-flex fill-height align-center justify-center text-center text-grey"
        >
          <div>
            <v-icon
              size="x-large"
